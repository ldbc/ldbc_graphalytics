...
public class DirectedBFSJob extends Configured implements Tool {
    ...
    public DirectedBFSJob(String inputPath, String intermediatePath, String outputPath, String sourceVertex) {
    ...
    public int run(String[] args) throws IOException {
        ...
        while (!isFinished) {
        	...
        	jobConfiguration.setJarByClass(DirectedBFSJob.class);

        	jobConfiguration.setMapOutputKeyClass(Text.class);
        	jobConfiguration.setMapOutputValueClass(Text.class);

        	jobConfiguration.setMapperClass(DirectedBFSMap.class);
