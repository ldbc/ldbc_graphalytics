 ...
 */
public class LongVertexValidator implements VertexValidator {
	...
	private Long2LongMap parseFile(Path file) throws IOException {
		Long2LongMap results = new Long2LongOpenHashMap();
