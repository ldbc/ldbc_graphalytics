 ...
 */
package science.atlarge.graphalytics.${platform-acronym}.algorithms.cdlp;
...
/**
 * Community Detection job implementation for ${platform-name}. This class is responsible for formatting CDLP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author ${developer-name}
 */
public final class CommunityDetectionLPJob extends ${platform-name}Job {
	 ...
	 */
	public CommunityDetectionLPJob(RunSpecification runSpecification, ${platform-name}Configuration platformConfig,
