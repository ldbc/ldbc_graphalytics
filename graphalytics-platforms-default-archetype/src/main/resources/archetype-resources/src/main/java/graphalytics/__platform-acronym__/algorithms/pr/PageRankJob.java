 ...
 */
package science.atlarge.graphalytics.${platform-acronym}.algorithms.pr;
...
/**
 * Page Rank job implementation for ${platform-name}. This class is responsible for formatting PR-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author ${developer-name}
 */
public final class PageRankJob extends ${platform-name}Job {
	 ...
	 */
	public PageRankJob(RunSpecification runSpecification, ${platform-name}Configuration platformConfig,
