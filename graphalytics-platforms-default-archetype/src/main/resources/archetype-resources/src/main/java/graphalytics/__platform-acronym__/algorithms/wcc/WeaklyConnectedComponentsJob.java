...
/**
 * Weakly Connected Components job implementation for ${platform-name}. This class is responsible for formatting WCC-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author ${developer-name}
 */
public final class WeaklyConnectedComponentsJob extends ${platform-name}Job {
