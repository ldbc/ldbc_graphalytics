...
############################################################################################
# each dataset is copied in a way to have exactly 25 blocks, thus fully utilize 25 wrokers (10mappers n 10reducers) #
############################################################################################
...
mkdir -p /var/scratch/yongguo/output/yarn_bfs/hs25_output_DotaLeague_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/hs25_output_$i\_DotaLeague_FCF/benchmark.txt /var/scratch/yongguo/output/yarn_bfs/hs25_output_DotaLeague_FCF/benchmark_$i
    echo "--- Clear dfs ---"
...
mkdir -p /var/scratch/yongguo/output/yarn_bfs/hs25_output_Friendster_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/hs25_output_$i\_Friendster_FCF/benchmark.txt /var/scratch/yongguo/output/yarn_bfs/hs25_output_Friendster_FCF/benchmark_$i
    echo "--- Clear dfs ---"
