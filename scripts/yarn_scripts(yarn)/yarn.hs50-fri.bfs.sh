...
mkdir -p /var/scratch/yongguo/output/yarn_bfs/hs50_output_Friendster_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/hs50_output_$i\_Friendster_FCF/benchmark.txt /var/scratch/yongguo/output/yarn_bfs/hs50_output_Friendster_FCF/benchmark_$i
    echo "--- Clear dfs ---"
