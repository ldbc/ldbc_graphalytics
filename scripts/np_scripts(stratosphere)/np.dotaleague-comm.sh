...
do
	...
	bash commcamb.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.CommunityDetectionCamb 20 hdfs://$nodename.cm.cluster:54310/local/hadoop.tmp.yongguo/DotaLeague_FCF hdfs://$nodename.cm.cluster:54310/local/hadoop.tmp.yongguo/output_$i\_DotaLeague_FCF u DotaLeague_FCF_test $i
	echo "--- Copy output ---"
