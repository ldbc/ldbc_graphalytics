...
do
        ...
        bash conn.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.ConnectedComponent 20 hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/WikiVote_FCF hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/output_$i\_WikiVote_FCF d WikiVote_FCF $i
        itemIndex=2
        ...
        echo "--- Copy output ---"
       #bash client.sh dfs -copyToLocal /local/yongguo/hadoop.tmp.yongguo/output_$i\_WikiVote_FCF/$lastfileNum /var/scratch/yongguo/output/conn/output_$i\_WikiVote_FCF
        echo "--- Clear dfs ---"
...
do
        ...
        bash conn.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.ConnectedComponent 20 hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/WikiTalk hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/output_$i\_WikiTalk d WikiTalk $i
        itemIndex=2
        ...
        echo "--- Copy output ---"
        #bash client.sh dfs -copyToLocal /local/yongguo/hadoop.tmp.yongguo/output_$i\_WikiTalk/$lastfileNum /var/scratch/yongguo/output/conn/output_$i\_WikiTalk
        echo "--- Clear dfs ---"
...
do
        ...
        bash conn.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.ConnectedComponent 20 hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/WebGraph_FCF hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/output_$i\_WebGraph_FCF d WebGraph_FCF $i
        itemIndex=2
        ...
        echo "--- Copy output ---"
       #bash client.sh dfs -copyToLocal /local/yongguo/hadoop.tmp.yongguo/output_$i\_WebGraph_FCF/$lastfileNum /var/scratch/yongguo/output/conn/output_$i\_WebGraph_FCF
        echo "--- Clear dfs ---"
...
do
        ...
        bash conn.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.ConnectedComponent 20 hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/EUEmail_FCF hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/output_$i\_EUEmail_FCF d  EUEmail_FCF $i
        itemIndex=2
        ...
        echo "--- Copy output ---"
       #bash client.sh dfs -copyToLocal /local/yongguo/hadoop.tmp.yongguo/output_$i\_EUEmail_FCF/$lastfileNum /var/scratch/yongguo/output/conn/output_$i\_EUEmail_FCF
        echo "--- Clear dfs ---"
...
do
        ...
        bash conn.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.ConnectedComponent 20 hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/Citation_FCF hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/output_$i\_Citation_FCF d Citation_FCF $i
        itemIndex=2
        ...
        echo "--- Copy output ---"
       #bash client.sh dfs -copyToLocal /local/yongguo/hadoop.tmp.yongguo/output_$i\_Citation_FCF/$lastfileNum /var/scratch/yongguo/output/conn/output_$i\_Citation_FCF
        echo "--- Clear dfs ---"
