...
do
        ...
        bash commcamb.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.CommunityDetectionCamb 20 hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/KGS_0_FCF hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/output_$i\_KGS_0_FCF u KGS_0_FCF $i
        itemIndex=2
        ...
        echo "--- Copy output ---"
       #bash client.sh dfs -copyToLocal /local/yongguo/hadoop.tmp.yongguo/output_$i\_KGS_0_FCF/$lastfileNum /var/scratch/yongguo/output/commcamb/output_$i\_KGS_0_FCF
        echo "--- Clear dfs ---"
...
do
        ...
        bash commcamb.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.CommunityDetectionCamb 20 hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/KGS_1_FCF hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/output_$i\_KGS_1_FCF u KGS_1_FCF $i
        itemIndex=2
        ...
        echo "--- Copy output ---"
        #bash client.sh dfs -copyToLocal /local/yongguo/hadoop.tmp.yongguo/output_$i\_KGS_1_FCF/$lastfileNum /var/scratch/yongguo/output/commcamb/output_$i\_KGS_1_FCF
        echo "--- Clear dfs ---"
...
do
        ...
        bash commcamb.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.CommunityDetectionCamb 20 hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/KGS_2_FCF hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/output_$i\_KGS_2_FCF u KGS_2_FCF $i
        itemIndex=2
        ...
        echo "--- Copy output ---"
       #bash client.sh dfs -copyToLocal /local/yongguo/hadoop.tmp.yongguo/output_$i\_KGS_2_FCF/$lastfileNum /var/scratch/yongguo/output/commcamb/output_$i\_KGS_2_FCF
        echo "--- Clear dfs ---"
...
do
        ...
        bash commcamb.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.CommunityDetectionCamb 20 hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/bbo_edgetonode hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/output_$i\_bbo_edgetonode u bbo_edgetonode $i
        itemIndex=2
        ...
        echo "--- Copy output ---"
       #bash client.sh dfs -copyToLocal /local/yongguo/hadoop.tmp.yongguo/output_$i\_bbo_edgetonode/$lastfileNum /var/scratch/yongguo/output/commcamb/output_$i\_bbo_edgetonode
        echo "--- Clear dfs ---"
...
do
        ...
        bash commcamb.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.CommunityDetectionCamb 20 hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/dotaleague_edgetonode hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/output_$i\_dotaleague_edgetonode u dotaleague_edgetonode $i
        itemIndex=2
        ...
        echo "--- Copy output ---"
       #bash client.sh dfs -copyToLocal /local/yongguo/hadoop.tmp.yongguo/output_$i\_dotaleague_edgetonode/$lastfileNum /var/scratch/yongguo/output/commcamb/output_$i\_dotaleague_edgetonode
        echo "--- Clear dfs ---"
...
do
        ...
        bash commcamb.sh ../biggraph.jar eu.stratosphere.pact.example.biggraph.CommunityDetectionCamb 20 hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/dotalicious_edgetonode hdfs://$nodename.cm.cluster:54310/local/yongguo/hadoop.tmp.yongguo/output_$i\_dotalicious_edgetonode u dotalicious_edgetonode $i
        itemIndex=2
        ...
        echo "--- Copy output ---"
       #bash client.sh dfs -copyToLocal /local/yongguo/hadoop.tmp.yongguo/output_$i\_dotalicious_edgetonode/$lastfileNum /var/scratch/yongguo/output/commcamb/output_$i\_dotalicious_edgetonode
        echo "--- Clear dfs ---"
