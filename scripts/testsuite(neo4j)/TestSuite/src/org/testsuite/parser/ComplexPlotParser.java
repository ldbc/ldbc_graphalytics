...
public class ComplexPlotParser {
    public Suite parseComplexPlot(Element root) throws TestSuiteException {
            Suite combinedSuites = new Suite(Suite.Technology.COMPLEX_PLOT);
