...
echo $nodename
mkdir -p /home/yongguo/glab_scripts/glab_bfs_coverage
mkdir -p /home/yongguo/glab_scripts/glab_bfs_coverage/KGS_1_FCF_output
mkdir -p /home/yongguo/glab_scripts/glab_bfs_coverage/amazon.302_FCF
mkdir -p /home/yongguo/glab_scripts/glab_bfs_coverage/Citation_FCF
mkdir -p /home/yongguo/glab_scripts/glab_bfs_coverage/WikiTalk_FCF
...
do
        ...
        mpiexec -n $1 -f machines  env CLASSPATH=`/home/yongguo/hadoop-0.20.203.0/bin/hadoop classpath` ./../graphlabapi/release/apps/bfs_multi_coverage --graph=hdfs://$nodename.cm.cluster:54310/local/hadoop.tmp.yongguo/KGS_1_FCF --saveprefix=~/glab_scripts/glab_bfs_coverage/KGS_1_FCF_output/out_  --rootvertex=88814 --ncpus=$2 --direct=u #> /home/yongguo/glab_scripts/glab_bfs/full_KGS_1_FCF_$1_$2_$i
...
do
	...
	mpiexec -n $1 -f machines  env CLASSPATH=`/home/yongguo/hadoop-0.20.203.0/bin/hadoop classpath` ./../graphlabapi/release/apps/bfs_multi_coverage --graph=hdfs://$nodename.cm.cluster:54310/local/hadoop.tmp.yongguo/amazon.302_FCF --saveprefix=~/glab_scripts/glab_bfs_coverage/amazon.302_FCF_output/out_  --rootvertex=99843 --ncpus=$2 --direct=d #> /home/yongguo/glab_scripts/glab_bfs/full_amazon.302_FCF_$1_$2_$i
...
do
        ...
        mpiexec -n $1 -f machines  env CLASSPATH=`/home/yongguo/hadoop-0.20.203.0/bin/hadoop classpath` ./../graphlabapi/release/apps/bfs_multi_coverage --graph=hdfs://$nodename.cm.cluster:54310/local/hadoop.tmp.yongguo/Citation_FCF --saveprefix=~/glab_scripts/glab_bfs_coverage/Citation_FCF_output/out_  --rootvertex=4949326 --ncpus=$2 --direct=d # > /home/yongguo/glab_scripts/glab_bfs/full_Citation_FCF_$1_$2_$i
...
do
        ...
        mpiexec -n $1 -f machines  env CLASSPATH=`/home/yongguo/hadoop-0.20.203.0/bin/hadoop classpath` ./../graphlabapi/release/apps/bfs_multi_coverage --graph=hdfs://$nodename.cm.cluster:54310/local/hadoop.tmp.yongguo/WikiTalk_FCF --saveprefix=~/glab_scripts/glab_bfs_coverage/WikiTalk_FCF_output/out_  --rootvertex=14591 --ncpus=$2 --direct=d #> /home/yongguo/glab_scripts/glab_bfs/full_WikiTalk_FCF_$1_$2_$i
