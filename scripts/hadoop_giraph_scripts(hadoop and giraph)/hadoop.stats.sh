...
mkdir -p /var/scratch/yongguo/output/hadoop_stats/output_amazon.302_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/output_$i\_amazon.302_FCF/benchmark.txt /var/scratch/yongguo/output/hadoop_stats/output_amazon.302_FCF/benchmark_$i
    echo "--- Clear dfs ---"
...
mkdir -p /var/scratch/yongguo/output/hadoop_stats/output_Citation_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/output_$i\_Citation_FCF/benchmark.txt /var/scratch/yongguo/output/hadoop_stats/output_Citation_FCF/benchmark_$i
    echo "--- Clear dfs ---"
...
mkdir -p /var/scratch/yongguo/output/hadoop_stats/output_WikiTalk_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/output_$i\_WikiTalk_FCF/benchmark.txt /var/scratch/yongguo/output/hadoop_stats/output_WikiTalk_FCF/benchmark_$i
    echo "--- Clear dfs ---"
...
mkdir -p /var/scratch/yongguo/output/hadoop_stats/output_Xfire_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/output_$i\_Xfire_FCF/benchmark.txt /var/scratch/yongguo/output/hadoop_stats/output_Xfire_FCF/benchmark_$i
    echo "--- Clear dfs ---"
...
mkdir -p /var/scratch/yongguo/output/hadoop_stats/output_Friendster_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/output_$i\_Friendster_FCF/benchmark.txt /var/scratch/yongguo/output/hadoop_stats/output_Friendster_FCF/benchmark_$i
    echo "--- Clear dfs ---"
