...
mkdir -p /var/scratch/yongguo/output/hadoop_bfs/hs35_output_DotaLeague_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/hs35_output_$i\_DotaLeague_FCF/benchmark.txt /var/scratch/yongguo/output/hadoop_bfs/hs35_output_DotaLeague_FCF/benchmark_$i
    echo "--- Clear dfs ---"
