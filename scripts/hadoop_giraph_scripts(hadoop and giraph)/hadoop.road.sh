...
mkdir -p /var/scratch/yongguo/output/hadoop_stats/output_road_CA_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/output_$i\_road_CA_FCF/benchmark.txt /var/scratch/yongguo/output/hadoop_stats/output_road_CA_FCF/benchmark_$i
    echo "--- Clear dfs ---"
...
#./client.sh dfs -copyFromLocal /var/scratch/yongguo/input/filtered/road_CA_FCF /local/hadoop.tmp.yongguo
./client.sh dfs -D dfs.block.size=2779648 -copyFromLocal /var/scratch/yongguo/sc_dataset/road_CA_FCF /local/hadoop.tmp.yongguo/road_CA_FCF
mkdir -p /var/scratch/yongguo/output/hadoop_bfs/output_road_CA_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/output_$i\_road_CA_FCF/benchmark.txt /var/scratch/yongguo/output/hadoop_bfs/output_road_CA_FCF/benchmark_$i
    echo "--- Clear dfs ---"
    ./client.sh dfs -rmr /local/hadoop.tmp.yongguo/output_$i\_road_CA_FCF
    rm -rf /var/scratch/${USER}/hadoop_giraph_logs/userlogs
done
...
#./client.sh dfs -copyFromLocal /var/scratch/yongguo/input/filtered/road_CA_FCF /local/hadoop.tmp.yongguo
./client.sh dfs -D dfs.block.size=2779648 -copyFromLocal /var/scratch/yongguo/sc_dataset/road_CA_FCF /local/hadoop.tmp.yongguo/road_CA_FCF
mkdir -p /var/scratch/yongguo/output/hadoop_comm/output_road_CA_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/output_$i\_road_CA_FCF/benchmark.txt /var/scratch/yongguo/output/hadoop_comm/output_road_CA_FCF/benchmark_$i
    echo "--- Clear dfs ---"
    ./client.sh dfs -rmr /local/hadoop.tmp.yongguo/output_$i\_road_CA_FCF
    rm -rf /var/scratch/${USER}/hadoop_giraph_logs/userlogs
done
...
#./client.sh dfs -copyFromLocal /var/scratch/yongguo/input/filtered/road_CA_FCF /local/hadoop.tmp.yongguo
./client.sh dfs -D dfs.block.size=2779648 -copyFromLocal /var/scratch/yongguo/sc_dataset/road_CA_FCF /local/hadoop.tmp.yongguo/road_CA_FCF
mkdir -p /var/scratch/yongguo/output/hadoop_conn/output_road_CA_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/output_$i\_road_CA_FCF/benchmark.txt /var/scratch/yongguo/output/hadoop_conn/output_road_CA_FCF/benchmark_$i
    echo "--- Clear dfs ---"
    ./client.sh dfs -rmr /local/hadoop.tmp.yongguo/output_$i\_road_CA_FCF
    rm -rf /var/scratch/${USER}/hadoop_giraph_logs/userlogs
done
...
#./client.sh dfs -copyFromLocal /var/scratch/yongguo/input/filtered/road_CA_FCF /local/hadoop.tmp.yongguo
./client.sh dfs -D dfs.block.size=2779648 -copyFromLocal /var/scratch/yongguo/sc_dataset/road_CA_FCF /local/hadoop.tmp.yongguo/road_CA_FCF
mkdir -p /var/scratch/yongguo/output/hadoop_evo/output_road_CA_FCF
...
do
    ...
    echo "--- Copy output ---"
    ./client.sh dfs -copyToLocal /local/hadoop.tmp.yongguo/output_$i\_road_CA_FCF/benchmark.txt /var/scratch/yongguo/output/hadoop_evo/output_road_CA_FCF/benchmark_$i
    echo "--- Clear dfs ---"
    ./client.sh dfs -rmr /local/hadoop.tmp.yongguo/output_$i\_road_CA_FCF
    rm -rf /var/scratch/${USER}/hadoop_giraph_logs/userlogs
done
