...
import org.hadoop.test.map.directed.LabelDirectedConnectedComponentsMap;
import org.hadoop.test.reduce.directed.LabelDirectedConnectedComponentsReducer;
...
public class LabelDirectedConnectedComponentsJob extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        while(!stop || !realStop) {
            ...
            connCompConf.setMapperClass(LabelDirectedConnectedComponentsMap.class);
            connCompConf.setReducerClass(LabelDirectedConnectedComponentsReducer.class);

            connCompConf.setOutputKeyClass(IntWritable.class);
            ...
            long counter = counters.getCounter(LabelDirectedConnectedComponentsJob.Label.UPDATED);
