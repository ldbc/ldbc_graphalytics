...
import org.hadoop.test.map.community.DirectedCambridgeLPAMap;
import org.hadoop.test.reduce.community.DirectedCambridgeLPAReducer;
...
public class DirectedCambridgeLPAJob extends Configured implements Tool {
    public int run(String[] args) throws IOException {
        ...
        while (!isFinished && (step < maxIterThreshold)) {
            ...
            lpaConf.setJarByClass(DirectedCambridgeLPAJob.class);

            lpaConf.setMapOutputKeyClass(VIntWritable.class);
            lpaConf.setMapOutputValueClass(Text.class);

            lpaConf.setMapperClass(DirectedCambridgeLPAMap.class);
            lpaConf.setReducerClass(DirectedCambridgeLPAReducer.class);
